...
Per gli orbitali 2s e 2', con i valori sperimentali dell'energia si ottengono valori di Z$^*$ pari rispettivamente a 1,08 e 0,997 protoni. Quindi l'elettrone 2s è fortemente schermato dalla carica nucleare dall'elettrone 1s, tant'è che sente poco più di 1 protone. Analogamente per l'elettrone 2p.
...
%metti grafico livelli energia orbitali.
...
Se passiamo al potassio che ha 19 elettroni, seguendo la sequenza di quella logica si penserebbe che ospiti il 19° elettrone in orbitali 3d (che in teoria sono quelli immeddiatamente disponibili dopo aver riempito i 3p) perché a stesso numero quantico, ma non è così: lo osserviamo nel 4s, lasciando quindi vuoti i 5 orbitali 3d.
