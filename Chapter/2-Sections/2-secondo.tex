...
$\quad m=-1, \; 0,\; 1$. Per ogni valore assunto da $m$, $s$ può valere $\pm\frac{1}{2}$, quindi 6 sequenze.
...
Il numero degli orbitali è determinato da $l$: fissato un certo valore di queste, avremo $2l+1$ orientazioni:
\begin{itemize}
