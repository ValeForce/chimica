...
\vspace{0.2cm}\textbf{DEF} Si dice densità di probabilità radiale l'insieme dei possibili valori del raggio e la relativa probabilità.
...
(In figura: robabilità di trovare l'elettrone in un guscio sferico, ottenuta dal quadrato del modulo della parte radiale dell'orbitale.)
...
\begin{figure}[htp]
  \centering
  \includegraphics[width=12cm]{immagini/livelli_orbitali.png}
\end{figure}
