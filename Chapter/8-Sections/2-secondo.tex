...
\begin{minipage}{0.45\textwidth}
    \vspace{0.7cm}Immaginiamo di avere un becher contenente una soluzione 1-molare di HCl in cui mettiamo un filo di platino saldato ad una lamina di platino, la quale in superficie è ricoperta di una polvere finissima di platino. Tale oggetto si chiama \textit{platino platinato}. Viene rivestito per aumentare la superficie di disposizione, perché si conta la superficie di ogni granello. Facciamo gorgogliare (quindi sotto la lamina) l'idrogeno che è un gas. Esso gorgogliando aderisce alla superficie della lamina, in quanto i grani finissimi di platino che ricoprono la lamina di platino fungono da supporto per le bollicine di idrogeno che vanno ad aderire sulla lamina.
\end{minipage}
}
...
Dato che abbiamo idrogeno che gorgoglia alla pressione di 1 atm e a $25 \; ^{\circ} \rm C$, siamo in condizioni standard.
...
Nel nostro esempio tale elettrodo ci permette di misurare la concentrazione del KCl. Se questo dovesse essere 1 molare, $a_{\text{Cl}^-}=1$ e allora diventa $E=E^0=0.268 \; \rm V$.
...
Quello che si fa nella pratica è immergere il ponte salino nel becher contenente l'altro elettrodo e col filo di platino tocchiamo il tester. A questo punto poggiamo un puntale sul filo di platino e l'altro sul secondo elettrodo.
...
\vspace{0.2cm}Quindi si riducono le specie che hanno il potenziale standard maggiore. Tutti gli elementi a potenziale negativo non vedranno mai sviluppata la loro riduzione in soluzione, al loro posto sarà lo ione $\rm H^+$ a ridursi in idrogeno: \ce{2H^+ + 2e^- <--> H_2}.
...
$$E^0 \quad \text{Sn}^{4+}/ \, \text{Sn}^{2+}=0.15 \; \rm V$$

\vspace{-0.3cm}$$E^0 \quad \text{Fe}^{3+}/ \, \text{Fe}^{2+}=0.77 \; \rm V$$
...
\begin{center}
    \begin{tabular}{p{2.3cm}|p{2cm}||p{1.8cm}|p{2cm}}
        ...
        $P_{\rm H_2}=1 \; \rm atm$ & $a_{\text{H}_3\text{O}^+}=1$ & $a_{\text{Ag}^+}=x$&\\[0.5ex]
    \end{tabular}
\end{center}
...
$$E=E^0_{(\text{Cu}^{2+}/\text{Cu})} - E^0_{(\text{Zn}^{2+}/\text{Zn})} = 0.337 - (-0.763) = 1.10 \; \rm V$$
...
\subsection[Reazioni di disproporzione \texorpdfstring{$E$(A/A$_{\rm rid}$)$>$$E$(A$_{\rm ox}$/A)}{}]%
{Reazioni di disproporzione $\boldsymbol{E}\mathbf{(A/A_{rid})>}\boldsymbol{E}\mathbf{(A_{ox}/A)}$}
...
\begin{center}
    \begin{tabular}{p{5.8cm}}
         ...
         \ce{Fe^{2+} + 2e^- -> Fe}, \; E^0= -0.41 \; \rm V\\
         \ce{Fe^{2+} -> Fe^{3+} + e^-}, \; E^0= 0.77 \; \rm V
         \end{cases}$\\
         \\[-1.5ex]
         \hline
         \\[-1.5ex]
...
\begin{center}
    \begin{tabular}{p{5.7cm}}
        \hspace{-0.6cm}$\begin{cases}
        \ce{Cu^+ + e^- -> Cu}, \; E^0=0.52 \; \rm V\\
        \ce{Cu^+ -> Cu^{2+} + e^-}, \; E^0=0.15 \; \rm V
        \end{cases}$\\
        \\[-1.5ex]
        \hline
        \\[-1.5ex]
...
\begin{center}
    \begin{tabular}{p{8.8cm}}
        \hspace{-0.6cm}$\begin{cases}
        \ce{\frac{1}{2}Cl_2 + e^- -> Cl^-}, \; E^0= 1.36 \; \rm V\\
        \ce{\frac{1}{2}Cl_2 + 2OH^- -> ClO^- + H_2O + e^-}, \; E^0=0.38 \; \rm V
        \end{cases}$\\
        \\[-1.5ex]
        \hline
        \\[-1.5ex]
...
\begin{center}
    \begin{tabular}{p{9.8cm}}
        \hspace{-0.6cm}$\begin{cases}
        \ce{2ClO^- +2H_2O + 4e^- -> 2Cl^- + 4OH^-}, \; E^0=0.88 \; \rm V\\
        \ce{ClO^- + 4OH^- -> ClO_3^- + 2H_2O + 4e^-}, \; E^0=0.5 \; \rm V
        \end{cases}$\\
        \\[-1.5ex]
        \hline
        \\[-1.5ex]
...
\begin{center}
    \begin{tabular}{p{1.8cm}|p{2cm}||p{2cm}|p{2cm}}
        ...
        $P_{\rm H_2}=P_1$ & $a_{\text{H}_3\text{O}^+}=a$ & $a_{\text{H}_3\text{O}^+}=a$ & $P_{\rm H_2}=P_2$\\[0.5ex]
    \end{tabular}
\end{center}
...
$$E= E_{\rm CHIN} - E_{\rm ECS} \implies E_{\rm CHIN}= E + E_{\rm ECS}$$

$$\implies E_{\rm CHIN} = E^{0}_{\rm CHIN} + 0.059 \log a_{\text{H}^+} = E + E_{\rm ECS}$$

$$\implies E_{\rm CHIN} = \rm  - 0.059 \text{pH} = E + E_{\rm ECS}$$

$$\implies \text{pH} = \frac{-E - E_{\rm ECS} + E^0_{\rm  CHIN}}{0.059}$$
...
\vspace{-1cm}$$\hspace{-0.2cm}a_{\rm H_3O^+}=x<1\hspace{3cm}a'_{\text{H}_3\text{O}^+}= 1 $$

La d.d.p. sarà

$$E=0.059 \log \frac{a'_{\text{H}_3\text{O}^+}}{a_{\text{H}_3\text{O}^+}}
\quad,\quad
a'_{\text{H}_3\text{O}^+}=1
\implies
E = 0.059 \log \frac{1}{a_{\text{H}_3\text{O}^+}}$$
