...
Per far ridurre l'NaCl lo mettiamo in un crogiolo di ossido di alluminio $\rm Al_2O_3$ (che può arrivare fino a 3000 gradi), riscaldiamo fino a $800 \; ^{\circ} \rm C$ cosicché l'NaCl fonde. Immergiamo gli elettrodi nel fuso e elettrolizziamo l'NaCl.
...
\begin{equation*}
  ...
  \end{aligned}\right\} f_{c.e.m.}=1.23 \; \rm V
\end{equation*}
...
\begin{center}
    \begin{tabular}{p{11.8cm}}
        ...
        \ce{Pb(s) + SO_4^{2-} -> PbSO_4 + 2e^-}, \; E^0=-0.36 \; \rm V\\
        \ce{PbO_2 + 4H_3O^+ SO_4^{2-} + 2e^- -> PbSO_4(s) + 6H_2O}, \; E^0=1.69 \; \rm V
        \end{cases}$\\
        \\[-1.5ex]
        \hline
        \\[-1.5ex]
...
$$\implies E^0=1.69 - (-0.36)=2.04 \; \rm V$$
...
\vspace{0.2cm}\textit{"Al fine di liberare agli elettrodi 1 equivalente di una qualsiasi sostanza è necessario che attraverso la soluzione passino $\rm 96485 \; C$ (quantità nota come Faraday). Naturalmente se attraverso la soluzione passano n Faraday verranno liberati n equivalenti."}
...
Per depositarli saranno necessari 31.4733 F di corrente, che corrispondono a $31.4733 \cdot 96485 = 3036701.351 \; \rm C$. Questa carica, divisa per il tempo espresso in secondi, darà l'intensità di corrente necessaria:

$$\frac{Q}{t(\text{s})} = I = \frac{3036701.351}{24 \cdot 3600} = 35.147 \; \text{Ampere}$$