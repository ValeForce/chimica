...
\begin{itemize}
    \item L'acqua;
    \item L'alcol metilico (o metanolo) CH$_3$OH, in quanto l'ossigeno è molto elettronegativo, fatto che fa creare una buona differenza di elettronegatività tra esso e l'idrogeno, conferendo una certa polarità alla molecola;
...
\hspace{-0.2cm}\begin{figure}[H]
    \includegraphics[width=15.6cm]{immagini/processo_di_soluzione.png}
\end{figure}
