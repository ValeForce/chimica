...
\comment{Ciò che si fa è fissare delle temperature scelte da noi (si parte da basse temperature) e leggere le corrispondenti tensioni di vapore. Dopodiché si va a vedere come varia la temperatura di fusione del ghiaccio al variare della pressione esterna esercitata, cioè scegliamo noi la pressione.
