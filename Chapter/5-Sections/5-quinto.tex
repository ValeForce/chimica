...
Si parte dalla legge dei gas, $PV=nRT$\footnote{$V$ è il volume del solvente, che per una soluzione diluita coincide col volume della soluzione stessa. $n$ è il numero di moli di soluto}. Nel caso particolare della pressione osmotica sarà
