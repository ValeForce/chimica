...
$$g_{H_2SO_4}=V\cdot d_{H_2SO_4}= 2 \cdot 1.9=3.8$$
Nota: come unità di misura della densità useremo g/mL per i liquidi e g/L per i gas.

I grammi necessari saranno
$$g_{H_2O}= V \cdot d_{H_2O}= 98 \cdot 1 = 98$$
Calcoliamo le moli
$$n_{H_2SO_4}=\frac{g}{M.M.}=\frac{3.8}{98.074}=0.038746=3.8746 \cdot 10^{-2}$$
$$n_{H_2O}=\frac{g}{M.M.}=\frac{98}{18.0528}=5.4398$$
...
$$\frac{V_{H_2SO_4}}{V_{tot}} \cdot 100= \frac{2}{100} \cdot 100 = 2 \%$$
c) Per le frazioni molari calcoliamo prima le moli totali
$$n_{tot}=n_{H_2SO_4} + n_{H_2O}=0.038746 + 5.4398= 5.4785$$
$$\implies \rchi_{H_2SO_4}=\frac{0.038746}{5.4785}=0.00707237
\qquad
\rchi_{H_2O}=\frac{5.4398}{5.4785}=0.992936$$

\vspace{0.2cm}A conferma della correttezza dei calcoli di ha che $\rchi_{H_2SO_4} + \rchi_{H_2O} \approx 1$.
...
N.B.: $M$ ci dà il numero corrispondente di moli se il volume finale della soluzione è 1000 mL. Ciò significa che la molarità è subito calcolabile come il rapporto tra il numero di moli ed il volume espresso in litri, ossia
$$M=\frac{n}{V(L)}=\frac{0.038746}{0.1}$$
f) Per la normalitò dobbiamo innanzitutto osservare che l'acido solforico ha due protoni, per cui quando si dissocia dà luogo a due ioni H$^+$ e uno ione SO$_4^{2-}$. Immaginando che ogni molecol di H$_2$SO$_4$ liberi entrambi i protoni in soluzione, il peso equivalente sarà uguale al peso molecolare diviso due, cioè sarà 49 anziché 98. Ne segue che il numero di equivalenti sarà il doppio del numero di moli:
