...
\begin{minipage}{0.5\textwidth}
    \vspace{0.2cm}Consideriamo adesso la molecola dell'etano \ce{C_2H_6}. In entrambi gli atomi di carbonio si ha ibridizzazione sp$^3$, quindi entrambi avranno quattro orbitali ibridi orientati lungo i vertici di un tetraedro
