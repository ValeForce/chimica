...
\subsection{Esempi}
    ...
    \vspace{0.2cm}$\bullet$\textbf{ES.4} NO n.e.=11
...
$$
    ...
    \vspace{0.2cm}$\bullet$ \textbf{ES.2} $\rm CO_3^{2-}$
    $$
...
\vspace{0.2cm}$\bullet$ \textbf{ES.4} $\rm NO_3^-$
   $$
