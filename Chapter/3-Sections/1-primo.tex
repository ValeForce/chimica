...
\draw(x1)..controls +(90:0.8cm)and+(north:0.8cm)..(x2);}

Dopo la freccia il litio non ha più l'elettrone 2s (quindi gli orbitali 2s e 2p sono tutti vuoti). Il fluoro invexe ha acquistato questo elettrone ceduto dal litio e adesso ha i livelli 2p pieni 