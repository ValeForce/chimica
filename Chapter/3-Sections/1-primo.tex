...
Per rispondere a queste domanda, dobbiamo introdurre una definizione impropria dell'\text{ordine di legame}(o bond order): per il momento questa sarà sufficiente, in seguito ne daremo una più precisa. 
...
\begin{itemize}
    ...
    In altre parole, nella molecola dell'ozono non abbiamo un doppio legame e uno semplice: entrambi i legami saranno una via di mezzo tra un legame semplice e uno doppio. Ne segue che l'ordine di legame non è 1 per un legame e 2 per l'altro, ma vale 1.5  per entrambi
    $$
    \chemfig{O-[,,,,,rddbond]O-[,,,,,rddbond]O}
    $$
    Quindi nella realtà le formule limite non sono vere, ma sono vere le loro combinazioni lineari.
    \item ES2 \ce{CO_3^{2-}}
    $$
