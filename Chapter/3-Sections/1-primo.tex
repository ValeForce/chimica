...
\subsection{Esempi}
    ...
    $\bullet$\textbf{ES2} \ce{O_2} n.e.=12
...
\subsection{Strutture molecolari pi sbaddu}
    ...
    $\bullet$ Ossiacidi comuni e i loro anioni
