...
\subsection[Orbitali molecolari leganti ed antileganti \texorpdfstring{$\sigma$}{\textsigma}]%
  {Orbitali molecolari leganti ed antileganti $\boldsymbol{\sigma}$}
...
\subsection[Orbitali molecolari leganti ed antileganti \texorpdfstring{$\pi$}{\textpi}]%
{Orbitali molecolari leganti ed antileganti $\boldsymbol{\pi}$}
...
\begin{itemize}
    ...
    \item Nel passaggio da C$_2$ a N$_2$ l'azoto ha un elettrone in più del carbonio, per cui avremo due elettroni in più. Vediamo una situazione intermedia: ionizziamo l'N$_2$, generando lo ione N$_2^+$, che differisce da C$_2$ per un solo elettrone. In questo caso abbiamo 5 elettroni di legame, quindi l'O.L. è 2.5;
...
Consideriamo la molecola dell'acido fluoridrico, che abbiamo etichettato come covalente polare. Cosa succederà? L'unico orbitale occupato nello stato fondamentale dell'idrogeno, ossia l'1s, interagirà con l'1s del fluoro? Servono delle regole che ci faranno da guida per costruire diagrammi di orbitali molecolari:
...
\begin{itemize}
    ...
    \item Il numero di elettroni negli orbitali p deve essere pari a $4 n + 2$ con $n \in \mathbb{N}$ (regola di Huckel)
\end{itemize}
...
Quindi questi 6 orbitali p perpendicolari al piano molecolare danno luogo a 6 orbitali molecolari $\pi$ fra i quali solo i 3 di legame sono riempiti. Pertanto oltre allo scheletro $\sigma$ che ci dà i legami semplici \ce{C-C} e \ce{C-H} abbiamo altri tre legami da sistemare all'interno dell'esagono, i quali costituiranno gli orbitali $\pi$.
...
Nel diamante troviamo un reticolo, simile a quello dei solidi ionici, costituito da tetraedri incastonati tra loro. Ciò porta il diamante ad avere il punto di fusione a $3550 \; ^{\circ} \rm C$.
...
Il quarzo ha un punto di ebollizione di $1550 \; ^{\circ} \rm C$.
