...
\begin{center}
    \begin{tabular}{m{4cm}|m{1.5cm}m{1.5cm}m{1.5cm}m{1.5cm}}
        ...
        \vspace{0.4cm}Numero di elettroni & \vspace{0.4cm}1 & \vspace{0.4cm}2 & \vspace{0.4cm}3 & \vspace{0.4cm}4\\
        \vspace{0.2cm}Ordine di legame & \vspace{0.2cm}$\displaystyle\frac{1}{2}$ & \vspace{0.2cm}1 & \vspace{0.2cm}$\displaystyle\frac{1}{2}$ & \vspace{0.2cm}0
    \end{tabular}
    \end{center}
...
Abbiamo visto che il diagramma
