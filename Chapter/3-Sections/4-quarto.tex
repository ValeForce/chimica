...
\begin{figure}[!tbp]
    ...
    \caption{Forze attrattive e \\
    repulsive nel legame covalente}
    \hfill
    {\includegraphics[width=9cm]{immagini/legame_covalente_H_2.png}\label{fig:f6}}
    \caption{Legame covalente \\
    nell'idrogeno H$_2$}
\end{figure}
...
& $\mathbf{B_2}$ & $\mathbf{C_2}$ & $\mathbf{N_2}$ & & $\mathbf{O_2}$ & $\mathbf{F_2}$\\
$\boldsymbol{\sigma^*}_{2p}$ & \orbital{0} & \orbital{0} & \orbital{0} & $\boldsymbol{\sigma^*}_{2p}$ & \orbital{0} & \orbital{0}\\
$\boldsymbol{\pi^*}_{2p}$ & \hspace{-0.25cm}\orbitals{00} & \hspace{-0.25cm}\orbitals{00} & \hspace{-0.25cm}\orbitals{00} & $\boldsymbol{\pi^*}_{2p}$ & \hspace{-0.25cm}\orbitals{11} & \hspace{-0.25cm}\orbitals{22}\\
$\boldsymbol{\sigma}_{2p}$ & \orbital{0} & \orbital{0} & \orbital{2} & $\boldsymbol{\pi}_{2p}$ & \hspace{-0.25cm}\orbitals{22} & \hspace{-0.25cm}\orbitals{22}\\
$\boldsymbol{\pi}_{2p}$ & \hspace{-0.25cm}\orbitals{11} & \hspace{-0.25cm}\orbitals{22} & \hspace{-0.25cm}\orbitals{22} & $\boldsymbol{\sigma}_{2p}$ & \orbital{2} & \orbital{2}\\
$\boldsymbol{\sigma^*}_{2s}$ & \orbital{2} & \orbital{2} & \orbital{2} & $\boldsymbol{\sigma^*}_{2s}$ & \orbital{2} & \orbital{2}\\
$\boldsymbol{\sigma}_{2s}$ & \orbital{2} & \orbital{2} & \orbital{2} & $\boldsymbol{\sigma}_{2s}$ & \orbital{2} & \orbital{2}\\
Ordine di legame & Uno & Due & Tre & & Due & Uno\\
Energia di dissociazione di legame (kJ/mol) & 290 & 620 &945 & & 498 & 155\\
Distanza di legame (pm) & 159 & 131 & 110 & & 121 & 143\\
Comportamento magnetico osservato (paramagnetico o diamagnetico) & Para & Dia & Dia & & Para & Dia
\end{tabular}
