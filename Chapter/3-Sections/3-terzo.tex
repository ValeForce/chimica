...
\vspace{0.2cm}Se anche una terza coppia solitaria va a sostituire l'ultimo atomo equatoriale, come nel caso dello ione triioduro, ci aspettiamo una geometria in cui le 3 coppie solitarie sono poste sul piano equatoriale a 120° l'una dall'altra e i 3 atomi di iodio allineati lungo l'asse. Questa molecola è quindi lineare:
$$
