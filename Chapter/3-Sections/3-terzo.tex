...
\vspace{0.2cm}$\bullet$ \textbf{ES.1} $\rm CH_4$ (4 coppie di legame)
    
\vspace{0.2cm}Nel metano la geometria che minimizza le repulsioni è quella tetraedrica, con angoli di legame di 109.5°.

\vspace{0.2cm}$\bullet$ \textbf{ES.2} $\rm NH_3$ (3 coppie di legame e una solitaria)
...
\vspace{0.2cm}$\bullet$ \textbf{ES.3} $\rm H_2O$ (2 coppie di legame e 2 solitarie)
...
$\bullet$ \textbf{ES.1} $\rm PCl_5$ (5 coppie di legame)
...
\vspace{0.2cm}$\bullet$\textbf{ES.3} $\rm ClF_3$ (3 coppie di legame e 2 solitarie)
...
\vspace{0.2cm}$\bullet$ \textbf{ES.1} $\rm SF_6$ (6 coppie di legame)
...
\vspace{0.2cm}$\bullet$\textbf{ES.2} $\rm IF_5$ (5 coppie di legame e una solitaria)
...
\vspace{0.2cm}$\bullet$\textbf{ES.3} ICl$_4^-$ (4 coppie di legame e due solitarie)
