...
\begin{center}
    \begin{tabular}{|p{3.7cm}||p{3.7cm}|}
         Fe(s) &  \, \big[$2.5 \cdot 10^{-1}$-M\big]\\[0.5ex]
         $\rm Fe^{2+}$ \, \big[$1.5 \cdot 10^{-2}$-M\big] & $\rm Cd^{2+}$\\[0.5ex]
    \end{tabular}
\end{center}

Fe(s) I Cd++ (0.8988 M) II Fe++ ( 0.0120 M) I Cd(s)
sapendo che  \ce{Fe(s) -> Fe^{2+}(aq) + 2 e^-} $E^0=0.44V$ e  + 2 e \ce{Cd^{2+}(aq) -> Cd(s)}, $E^0=-0.40V$.
