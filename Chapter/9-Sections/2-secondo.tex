...
\implies
n_{\rm HNO_3}=\frac{8 \cdot 0.15}{3}=0.4 \; mol$$
...
\implies
n_{\rm NO}=\frac{0.35}{4}=8.75 \cdot 10^{-2} \; mol$$

I litri si calcoleranno tramite l'equazione di stato dei gas

$$PV=nRT \implies V_{\rm NO}=\frac{8.75 \cdot 10^{-2} \cdot 0.082 \cdot 273.15}{1}=1.9598 \; L$$
