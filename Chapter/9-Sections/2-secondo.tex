...
\vspace{0.2cm}\textbf{2.4} Calcolare i grammi di solfato ferrico che si ottengano mescolando in acqua 2.3456 grammi di permanganato di potassio  ed 12,3456 grammi di solfato ferroso, in eccesso di acido solforico.
...
\vspace{0.2cm}\textbf{2.6} Lo zinco in acido cloridrico produce cloruro di zinco ed idrogeno. Calcolare il volume di
...
\vspace{0.2cm}\textbf{2.7}  Bilanciare la seguente reazione e calcolare i grammi di $\rm CO_2$ $(MM=44.01)$ liberati da 2.0000 grammi di $\rm KMnO_4$ $(MM=158.04)$:


$$\ce{KMnO4 + K2C2O4 + H2SO4 -> MnSO4 + CO2 + K2SO4 + H2O}$$


\vspace{0.2cm}\textbf{2.8} Bilanciare la seguente reazione e calcolare i litri di SO2 a c.n. necessari per la riduzione di 1.5
...
\vspace{0.2cm}\textbf{2.9} Bilanciare la seguente reazione e calcolare i grammi di permanganato necessari per ossidare una
...
\vspace{0.2cm}\textbf{2.10} Bilanciare la seguente reazione e calcolare il volume di NO misurato a c.n. che si sviluppa a
...
\vspace{0.2cm}\textbf{2.11} Bilanciare la seguente reazione e calcolare i grammi di cloruro di zinco che si ottengono a partire da 3.1234 grammi di anidride arseniosa.
...
\vspace{0.2cm}\textbf{2.12} Bilanciare la reazione e calcolare il volume di cloro gassoso necessario per ottenere 10 litri di ipoclorito 2.0 M:
...
\vspace{0.2cm}\textbf{2.13} Calcolare i grammi di solfato ferrico che si ottengano mescolando in acqua 2.3456 grammi di permanganato di potassio  e 12,3456 grammi di solfato ferroso, in eccesso di acido solforico.
