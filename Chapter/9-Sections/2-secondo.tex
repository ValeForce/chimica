...
\begin{esercizio}
    Bilanciare la seguente reazione e calcolare i litri di $\rm SO_2$ a c.n. necessari per la riduzione di 1.5 grammi di bicromato di potassio.
    \begin{gather*}
...
\begin{soluzione}
    ...
    A questo punto calcoliamo i litri di $\rm SO_2$ necessari per ridurre il bicromato di potassio. Calcoliamo le moli di quest'ultimo:
    \begin{equation*}
        n_{\rm K_2Cr_2O_7}
        =\frac{1.5}{294.19}
        =5.0987 \cdot 10^{-3} \; \rm mol
    \end{equation*}
    Il rapporto stechiometrico tra bicromato e anidride solforosa è $1:3$, per cui le moli di $\rm SO_2$ saranno date dalla proporzione
    \begin{equation*}
...
\begin{esercizio}
    Il cloro può essere preparato per reazione del diossido di manganese con acido cloridrico. Dopo aver bilanciato la semplice reazione redox, determinare quanti grammi di diossido di manganese sono necessari per sviluppare 10 L di cloro a 1200 Torr e 18 $^{\circ} \rm C$.
\end{esercizio}
\begin{soluzione}
    La reazione che avviene è
    \begin{equation*}
    ...
    \begin{equation*}
        \begin{split}
            \ce{MnO_2} & \ce{-> Mn^{4+} + 2O^{2-}}
            \\
            \ce{HCl} & \ce{-> H^+ + Cl^-}
            \\
            \ce{MnCl_2} & \ce{-> Mn^{2+} + 2Cl^-}
            \\
            \ce{Cl_2} & \ce{-> Cl_2^{0}} \text{ (non si dissocia)}
        \end{split}
    \end{equation*}
    Il manganese passa da n.o. $+4$ nel diossido di manganese a n.o. $+2$ nel cloruro di manganese, quindi si è ridotto; il cloro passa da n.o. $-1$ nell'acido cloridrico a n.o. $0$ nel $\rm Cl_2$, quindi si è ossidato.\\
    La reazione semplificata sarà
    \begin{equation*}
        \ce{Mn^{4+} + O^{2-} + H^+ + Cl^- -> Mn^{2+} + Cl_2 + H_2O}
    \end{equation*}
    Le semireazioni redox che avvengono sono
    \begin{equation*}
        \begin{cases}
        ...
        \end{cases}
    \end{equation*}
    Non dovendo moltiplicare nulla, passiamo direttamente a bilanciare le cariche. A sinistra abbiamo 4 cariche positive dal manganese, una carica negativa dall'ossido e una carica negativa dal cloruro, per un totale di 4 cariche positive; a destra abbiamo solo 2 cariche positive dal manganese. La differenza è di 2 cariche positive, per cui ci servono 2 ioni $\rm H^+$ e quindi una molecola d'acqua:
    \begin{equation*}
        \ce{Mn^{4+} + O^{2-} + 2H^+ + 2Cl^- -> Mn^{2+} + Cl_2 + H_2O}
    \end{equation*}
    La reazione completa sarà
    \begin{equation*}
        \ce{MnO2 + 4HCl -> MnCl2 + Cl2 + 2H2O}
    \end{equation*}
    A questo punto calcoliamo i grammi di $\rm MnO_2$ necessari
    per sviluppare 10 L di cloro a 1200 Torr e 18 $^{\circ} \rm C$. Il rapporto stechiometrico tra il diossido di manganese e il cloro è $1:1$, per cui le moli di $\rm MnO_2$ saranno uguali a quelle di $\rm Cl_2$. Calcoliamo quindi le moli di cloro tramite l'equazione di stato dei gas:
    \begin{equation*}
        PV=nRT
        \implies
        n=\frac{PV}{RT}
        =\frac{1200 \cdot 10}{0.082 \cdot 291.15}
        =502.78 \; \rm mol
    \end{equation*}
    Dunque le moli di diossido di manganese saranno anch'esse 502.78 moli, e i grammi corrispondenti saranno
    \begin{equation*}
        m=n \cdot M
        =502.78 \cdot 86.936
        =43707.7 \; \rm g
