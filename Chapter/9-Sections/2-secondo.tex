...
\textbf{2.22} Bilanciare la seguente reazione e calcolare il volume di monossido di azoto a c.n. che si ottiene a partire da 4.7523 grammi di solfuro di rame:

\begin{center}
    acido nitrico + solfuro di rame \ce{->} nitrato di rame + zolfo + monossido di azoto + acqua
\end{center}
