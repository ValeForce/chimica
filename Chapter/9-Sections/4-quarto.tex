...
Mentre lo ione $\rm Na^+$ non subisce ulteriori reazione, lo ione ipoclorito $\rm ClO^-$, che è la base coniugata dell'acido ipocloroso il quale è un acido debole (ciò lo deduciamo dal valore della costante $K_a$), reagirà con l'acqua strappandole un protone per formare $\rm HClO$ e lasciando un eccesso di ioni $\rm OH^-$:
