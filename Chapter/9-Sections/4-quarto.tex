...
Entrambe le specie quindi in acqua producono ioni $\rm H_3O^+$, per cui in questo caso per calcolare il pH dovremo sommare le concentrazioni degli ioni $\rm H_3O^+$ prodotti da ogni specie.
