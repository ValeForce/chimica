...
Il rapporto stechiometrico tra acido solforico e ossido di alluminio è 3:1, per cui i due composti reagirebbero totalmente soltanto se il numero di moli di acido fossero pari al triplo di quelle dell'ossdio. Non essendo così, reagiranno tutte le moli di acido (e quindi a fine reazioni non avremo grammi di questo) ma le moli di ossido che reagiscono saranno pari a
...
Per quanto riguarda i prodotti dobbiamo tenere come riferimento le moli di acido soloforico (\textbf{continua})