...
\textbf{1.1.7} Trovare il volume in litri di biossido di zolfo a 35° C e 740 Torr ottenuto a partire dalla combustione di 2.7543 grammi di un minerale al 75\% pirite\footnote{Anche nota come l'oro degli sciocchi, è possibile vederla in "\textit{Barbie - La principessa e la povera}", dove Annalisa la osserva con una lente di ingrandimento.} (persolfuro ferroso, FeS2).
...
=2.0646 \cdot 10^{-2} \; mol$$

Il volume si ottiene dall'equazione di stato dei gas

$$PV=nRT
\implies
V=\frac{nRT}{P}=\frac{2.0646 \cdot 10^{-2} \cdot 0.082 \cdot 308.15 \cdot 760}{740}=0.5358 \; L$$
...
\vspace{0.2cm}\textbf{1.2.15} Una miscela di massa m=1.5400 g di ossido di bario (BaO) e ossido di calcio (CaO), ha richiesto 40 mL di acido cloridrico 1 M per essere trasformati in cloruri. Calcolare la percentuale in massa dei due ossidi della miscela.
...
$$\implies
\begin{cases}
    x=4.4066 \cdot 10^{-3} \;mol\\
    y=1.5593 \cdot 10^{-2} \;mol
\end{cases}$$
