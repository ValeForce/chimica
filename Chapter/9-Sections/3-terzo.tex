...
\begin{esercizio}[$\bigstar$]
    Quanti litri di solfuro di idrogeno $\rm H_2S$ a condizioni normali ($1 \; \rm atm$ e $0 \; ^{\circ}\rm C$) sono stati necessari per precipitare l'antimonio come solfuro da una soluzione contenente 10 grammi di tricloruro di antimonio $\rm SbCl_3$?
\end{esercizio}
\begin{soluzione}
...
\begin{esercizio}[$\bigstar$]
    Una soluzione 0.1 m di acido dicloro acetico congela a $0.278 \; \rm ^{\circ} C$ ($k_{cr}=1.86 \; \rm ^{\circ} C \cdot kg/mol$). Calcolare la percentuale di soluto presente in soluzione come ione idrogeno $\rm H^+$, ione dicloro acetato $\rm CHCl_2COO^-$ e molecole indissociate dell'acido.
\end{esercizio}
\begin{soluzione}
    \begin{equation*}
        \schemestart
...
\begin{esercizio}
    Qual è la percentuale in massa di acetato di etile in una miscela di questo e acetato di propile, sapendo che $P_{\rm et.}^0=415 \; \rm Torr$ e $P_{\rm pr.}^0=172 \; \rm Torr$ e che a $60 \; ^{\circ} \rm C$ questa miscela ha una tensione di vapore di $250 \; \rm Torr$?
\end{esercizio}
\begin{soluzione}
    ...
    \end{equation*}
    Poiché $\rchi_{\rm et.} + \rchi_{\rm pr.}=1$ allora $\rchi_{\rm pr.}=1 - \rchi_{\rm et.}$. L'espressione diventa
    \begin{gather*}
        250
