...
\comment{\vspace{0.2cm}Vediamo adesso perché nel calcolo delle costanti di dissociazione non figura la concentrazione dell'acqua.

La costante di autodissociazione dell'acqua, a 25°C, vale $1.8 \cdot 10^{-16}$. Essendo così piccola, le molecole d'acqua che si sono dissociate saranno un numero piccolissimo; ne segue che possiamo immaginare che all'equilibrio il numero di molecole di acqua sia uguale a quello che si ha prima che avvenga. Potendo fare questa assunzione, si ingloba la concentrazione dell'acqua nella costante e si calcola il nuovo valore di $k_w$:}
