...
Nel caso speciefico di questa reazione, conviene utilizzare come indicatore una sostanza chiamata \textit{fenoltaleina}, o meglio soluzioni estremamente diluite (all'1\%) di questa. Basta aggiungere una goccia di questa soluzione nel becher per poter osservare un cambio di colore quasi immediato. Quando?
