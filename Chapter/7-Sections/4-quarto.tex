...
$$\frac{0.1}{1000} \cdot 10=10^{-3}=0.001 \; \rm eq$$
...
\subsection{Acidi deboli}\label{par:acidi_deboli}
...
$$n_{\text{acido}}=\frac{0.1}{1000}\cdot 100 = 0.01 \; \rm mol$$

Le moli di NaOH aggiunte sono

$$n_{\text{NaOH}}=\frac{0.1}{1000}\cdot 10 = 0.001 \; \rm mol$$
...
\begin{center}
    \begin{tabular}{p{5cm}p{8cm}}
        $[\text{H}_3\text{O}^+]=K_a \cdot \displaystyle \frac{C_a}{C_s}$ & acido debole + suo sale con base forte\\[0.4cm]
...
Esempi di ciò sono il nitrato di potassio e il solfuro di mercurio. Della prima specie a $100 \; ^{\circ} \rm C$ se ne sciolgono circa 850 grammi in un litro di soluzione, mentre la seconda è talmente insolubile che forse in soluzione si scioglie qualche molecola.
