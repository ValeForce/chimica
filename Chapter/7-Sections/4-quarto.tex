...
Quindi, dopo la prima aggiunta e prima della reazione, abbiamo 0.01 eq di HCl e 0.001 eq di NaOH. Ci accorgiamo che quest'ultimo è in difetto, quindi sarà tutto consumato per produrre cloruro di sodio. Ne segue che avremo $10^{-3}$ moli di NaCl, mentre di HCl ne resterà la differemza, cioè $9 \cdot 10^{-3}$ moli.
