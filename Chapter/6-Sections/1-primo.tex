...
\vspace{-1.4cm}Riportiamo adesso alcuni esempi dei valori delle costanti di equilibrio.

\hspace{-0.5cm}\scriptsize\begin{tabular}{p{3.4cm}p{1.6cm}p{2.5cm}p{3.4cm}p{1.6cm}p{2.5cm}}
