...
Se il legame \ce{ A\bond{-}O} è più polare del legame \ce{ O\bond{-}H}, sarà esso che in soluzione acquosa tenderà a rompersi più facilmente, generando quindi una base \(\ce{(A++ + 2OH^-)}\), conservando l’integrità del gruppo OH, ed allora il composto va scritto come: $\rm A(OH)_2$.
