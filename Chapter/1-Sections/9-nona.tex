...
Per il ferro dobbiamo innanzitutto notare che al secondo membro ci sono 2 atomi, per cui dobbiamo moltiplicare per 2 il ferro al primo membro (ecco perché nella reazione semplificata c'è \ce{2Fe^2+}). Al primo mebro è ione ferroso \ce{Fe^2+}, al secondo ione ferrico \ce{Fe^3+}, ciò significa che ha ceduto 1 elettrone e quindi si sta ossidando
...
Per il cromo non ho problemi col numero di atomi, per lo iodio si perché a destra è in forma molecolare \ce{I_2} per cui devo moltiplicare per 2 a sinistra 