...
\vspace{0.2cm}$\bullet$ \textbf{Atomi o molecole omonucleari (tipo $O_2$)}
...
$$\ce{Fe^{3+} + e^- -> Fe^{2+}}$$
$$\ce{Sn^{2+} -> Sn^{4+} + 2 e^-}$$
Queste sono chiamate \textit{semireazioni redox}.
...
A secondo membro 2 ioni $\rm Mn^2+$ danno 4 cariche positive, ma al primo mebro ci sono solo 2 cariche negative dato dai due ioni $\rm MnO_4-$. Servono quindi 2 cariche positive per neutralizzarle e altre 4 per bilanciare, quindi aggiungiamo in totale 6 ioni $\rm H^+$. Possiamo bilanciare anche le masse, la reazione sarà:
...
Questa è una reazione che avviene a freddo in ambiente basico, per cui stavolta al posto dell'$\rm H^+$ ci sarà l'$OH^-$.
