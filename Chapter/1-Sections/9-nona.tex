...
\vspace{0.2cm}$\bullet$ \textbf{Atomi o molecole omonucleari(tipo \ce{O_2})}
Essi avranno numero di ossidazione pari a zero sempre.
$$\ce{Fe,\;Zn,\;Cl_2,\;O_2,\;N_2,\;P_4,\;S_8}\quad \text{n.o.=0}$$

\vspace{0.2cm}$\bullet$  \textbf{L'idrogeno (\ce{H_2} molecola omonucleare)}
...
\vspace{0.2cm}\textbf{ES} $\ce{H_2O}\qquad$
