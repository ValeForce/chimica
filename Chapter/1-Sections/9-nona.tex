...
\vspace{0.2cm}$\bullet$ \textbf{Atomi o molecole omonucleari (tipo O$_2$)}

Essi avranno numero di ossidazione pari a zero sempre.
$$\ce{Fe,\;Zn,\;Cl_2,\;O_2,\;N_2,\;P_4,\;S_8}\quad \text{n.o.=0}$$

$\bullet$  \textbf{L'idrogeno (H$_2$ molecola omonucleare)}
